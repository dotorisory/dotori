      ...
      <section className="container" style={{ margin: '48px auto', maxWidth: '900px' }}>
        ...
        >
          ...
          <p style={{ fontSize: '1.12rem', color: '#444', marginBottom: '1.5rem', textAlign: 'left' }}>
            ...
            <br />
            <br />
            I chose the name Dotori—meaning "acorn" in Korean—because I believe every learner holds the
            potential to grow into something extraordinary, given the right care, guidance, and environment.
          </p>
